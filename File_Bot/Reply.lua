...
if text == 'هلو' then
TextReply = ' هـلاوات يحيلي 💘🏌️ '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شلونكم' then
TextReply = ' تـمـام عمࢪيي ونت شلخبار؟ '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شلونك' then
TextReply = ' نكول زينين ونت عمࢪيي؟ '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تمام' then
TextReply = ' تـدوم يروحي💗 '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلاو' then
TextReply = ' هـلاوات يگمر 💘 '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😐' then
...
if text == 'تحبني' then
TextReply = ' احبڪ حب ؏ـبادهہ مِہטּ البصࢪا للڪࢪادهہ  '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '🌚' then
...
if text == 'اهمس' or text == 'همسه'  or text == 'بوت همسه'  or text == 'اريد همسه'  or text == 'همسولي'  or tex == 'دز همسه'  or text == 'اهمسلي' then
TextReply = 'بوت همسه ميديا لطيف @THiibot 💘'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'احبج' then
